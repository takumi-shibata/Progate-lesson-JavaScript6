...
// findメソッド(条件式に合う最初の1つ目の要素を配列の中から取り出すメソッド)
...
// filterメソッド(条件式に合う要素を全て取り出すメソッド)
...
// mapメソッド(配列内のすべての要素に処理を行い、新しい配列を作成するメソッド)
